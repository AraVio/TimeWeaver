    ...
    def iteration(self, epoch, dataloader, train=True):
        ...
        if train:
            ...
            for i, batch in rec_data_iter:
                ...
                user_ids, input_ids, time_ids, answers, neg_answer, same_target = batch

                loss = self.model.calculate_loss(input_ids, time_ids, answers, neg_answer, same_target, user_ids)
            ...
            for i, batch in rec_data_iter:
                batch = tuple(t.to(self.device) for t in batch)
                user_ids, input_ids, time_ids, answers, _, _ = batch

                recommend_output = self.model.predict(input_ids, time_ids, user_ids)
